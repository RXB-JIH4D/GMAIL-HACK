...
\_| |_/\__,_|_| |_|_| |_|\___|_|   
  ...
  _____  __   ______         _ _____ _    _ _  _   _____  
 |  __ \ \ \ / /  _ \       | |_   _| |  | | || | |  __ \ 
 | |__) | \ V /| |_) |      | | | | | |__| | || |_| |  | |
 |  _  /   > < |  _ <   _   | | | | |  __  |__   _| |  | |
 | | \ \  / . \| |_) | | |__| |_| |_| |  | |  | | | |__| |
 |_|  \_\/_/ \_\____/   \____/|_____|_|  |_|  |_| |_____/ 
...
def desc():
    ...
    Usage of  for attacking targets without prior mutual consent is illegal.
...
def SSH_Brut():
	...
	try:
		...
		user = input(W+'RXB JIH4D»SSH»User»'+E)
		if user == "":
			user = 'admin'
		print(G+'Enter password file:'+E)
		password = input(W+'RXB JIH4D»SSH»Password»'+E)
...
def FTP_Brut():
	...
	host = input(W+'RXB JIH4D»Ftp»Host»'+E)
	print(B+'Enter user:'+E)
	print(F+'Default: admin')
	user = input(W+'RXB JIH4D»Ftp»User»'+E)
	print(B+'Enter password file:'+E)
	password_list = input(W+'RXB JIH4D»Ftp»Password»'+E)
	if user == '':
		user = 'admin'
	if password_list == '':
...
def mail():
	...
	mail = input(W+'RXB JIH4D»Mail»Login»'+E)
	print(B+'Enter password list:'+E)
	password = input(W+'RXB JIH4D»Mail»Password»'+E)
	if password == '':
